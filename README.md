...
> 部分进阶模块（灵绘节点工作台、3D 导演工作台、全景节点、商业模型渠道、私有提示词工程等）**尚未开源**，仅在官方发布的安装包中提供，会随版本逐步开放。详细标注见下方[功能特性](#功能特性)。
...
<div align="center">
  <img src="./assets/contact/02.jpg" alt="Koma Studio 联系方式（Bot）" width="280" />
</div>

- 商务合作 / 定制咨询：通过上方联系方式或在 Issue 中说明诉求
